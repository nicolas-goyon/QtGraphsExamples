#include "LineChartEditorDataProvider.h"
#include <QVariantMap>

LineChartEditorDataProvider::LineChartEditorDataProvider(QObject *parent) : QObject(parent) {}

QVariantList LineChartEditorDataProvider::makePoints(
...
QVariantList LineChartEditorDataProvider::londonData() const
{
    return makePoints({
...
QVariantList LineChartEditorDataProvider::madridData() const
{
    return makePoints({
...
QVariantList LineChartEditorDataProvider::helsinkiData() const
{
    return makePoints({
